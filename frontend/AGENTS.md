...
**Buyer:** `RequestForm` → `runDemo()` (POST /api/run-demo) → `DemoResult` → `DecisionScreen`
...
| `src/components/modals/EscalationModal.tsx` | Human-alert inline modal |
